...
type ChannelOtherSettings struct {
	...
	DisableToolChoice                     bool                  `json:"disable_tool_choice,omitempty"`        // 是否禁用 tool_choice 透传（用于不支持 tool_choice 的端点）
...
func (s *ChannelOtherSettings) IsBambooLegacyCacheKey() bool {
	if s == nil || s.BambooLegacyCacheKey == nil {
		return false
	}
