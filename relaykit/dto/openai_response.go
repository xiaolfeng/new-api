...
type ResponsesOutput struct {
	...
	// Summary is the Responses reasoning summary slot. Chat conversion does
	// not invent summaries; omitempty keeps official goldens unchanged.
	Summary []ResponsesReasoningSummaryPart `json:"summary,omitempty"`
	// EncryptedContent is server-encrypted reasoning, forwarded as-is.
