...
// ClaudeStreamToolState holds transient stream assembly for Claude tool_use blocks.
...
type RelayInfo struct {
	...
	*TaskRelayInfo
	...
	// ClaudeStreamTools is transient stream state for assembling tool_use JSON.
	ClaudeStreamTools *ClaudeStreamToolState
