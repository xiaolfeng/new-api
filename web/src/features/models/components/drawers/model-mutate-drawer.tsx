...
export function ModelMutateDrawer({
  ...
  const modelSettings = useMemo(() => {
    ...
    const defaultModelSettings: ModelSettings = {
      ...
      'bamboo.enable_host_tools': false,
      'bamboo.host_tool_mode': 'loop',
      'bamboo.search_backend': 'off',
      'bamboo.allow_third_party_search_egress': false,
      'bamboo.search_fallback': '[]',
      'bamboo.searxng_base_url': '',
      'bamboo.exa_mcp_url': 'https://mcp.exa.ai/mcp',
      'bamboo.parallel_mcp_url': 'https://search.parallel.ai/mcp',
      'bamboo.max_search_results': 8,
      'bamboo.max_fetch_bytes': 1048576,
      'bamboo.host_tool_timeout_ms': 15000,
      'bamboo.enable_image_recognize': false,
      'bamboo.image_recognize_channel_id': 0,
      'bamboo.image_recognize_model': '',
